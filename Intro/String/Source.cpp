...
public:
	...
	{
		//0) проверить не €вл€етс€ ли другой объект нашим объектом
		if (this == &other)return *this;
		//1) сначала удал€ем старое значение объекта
		delete[] this->str;
...
void main()
{
	...
	string str3 = str1 + str2; //операвтор + будет выполн€ть конкатенацию (сли€ние) строк
	std::cout << delimiter << std::endl;
	...
	//string str2(); // объ€вл€ест€ функци€ str2, котора€ ничего не принимает и возвращает значение типа string
